...
elastixImageFilter$SetParameterMap(ReadParameterFile(args[3]))
...
# Write result image
WriteImage(elastixImageFilter$GetResultImage(), args[4])

# Write parameter file. This example only supports one parameter map and one transform parameter map.
WriteParameterFile(elastixImageFilter$GetTransformParameterMaps()[[1]], args[5])
