...
if ( WRAP_PYTHON )
  ...
  if ( Python_FOUND )
    if ( NOT "${Python_VERSION_MAJOR}.${Python_VERSION_MINOR}" IN_LIST Python_ADDITIONAL_VERSIONS  )
      message( WARNING "Python version \"${Python_VERSION}\" not in supported list ${Python_ADDITIONAL_VERSIONS}." )
    endif()
    ...
    if ( NOT "${PYTHON_VERSION_MAJOR}.${PYTHON_VERSION_MINOR}" IN_LIST Python_ADDITIONAL_VERSIONS  )
      message( WARNING "Python version \"${PYTHON_VERSION_STRING}\" not in supported list ${Python_ADDITIONAL_VERSIONS}." )
    endif()
